            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="table-action">
                        <!-- Accept button -->
                       <!-- Accept button (status changes to in progress instead of completed) -->
...
<!-- Complete button (status changes to completed only when consultation is over) -->
@if($appointment->status === 'in progress')
    <form method="POST" action="{{ route('appointments.update', $appointment->id) }}">
        @csrf
        @method('PUT')
        <input type="hidden" name="status" value="completed">
        <button style="width:100px;margin-top:10px" type="submit" class="btn btn-sm bg-success-light">
...
@endif
                        ...
                        <!-- If appointment is accepted, show "Add Medical Record" -->
